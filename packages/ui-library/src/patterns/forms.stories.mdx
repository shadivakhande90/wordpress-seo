...
import { Root, AutocompleteField, Autocomplete, Button, Card, Checkbox, Code, Label, SelectField, Select, TagField, TagInput, TextField, TextInput, Title } from "..";

<Meta title="3) Patterns/Forms" component={Card} />

<Root>
<Title className="yst-mb-3">Creating forms</Title>
...
<Root>
<Title className="yst-mb-3">Aligning elements</Title>
  ...
  <Story name="Aligning fields">
    ...
    <div className="yst-space-y-8 yst-mt-4">
      <div className="yst-flex yst-gap-6">
        <TextField className="yst-grow" id="story2-1" label="First name" />
        <TextField className="yst-grow" id="story2-2" label="Last name" />
      </div>
      <div className="yst-flex yst-gap-6">
        <TextField className="yst-grow" id="story2-3" label="Street" />
        <TextField id="story2-4" label="Number" />
      </div>
    </div>
  </Story>
</Canvas>
